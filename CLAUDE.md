...
7. **AI imports** (plan agreed with George, 24 Sep 2026; build in the order below, each its own approved step with tests). See "Step 7 plan" below. (a) menu price history: done. (b) invoice import: done. (c) till import: done. (d) menu import: done.
