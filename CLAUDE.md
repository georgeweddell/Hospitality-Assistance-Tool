...
- `frontend/` holds the React app.
  ...
  - Reports (`ReportsPage.jsx`, `#/reports` and `#/reports/<id>`; not in the nav, reached from the Overview): see "report agent" below. `GenerateReportButton` starts one for the chosen period and opens it.
